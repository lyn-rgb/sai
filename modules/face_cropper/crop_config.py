...
class CropConfig(PrintableConfig):
    insightface_root: str = "/inspire/hdd/project/agileapplication/zhangkaipeng-24043/mm1/CloneMyFaceCloneMyVoice/LivePortrait/pretrained_weights/insightface"
    landmark_ckpt_path: str = "/inspire/hdd/project/agileapplication/zhangkaipeng-24043/mm1/CloneMyFaceCloneMyVoice/LivePortrait/pretrained_weights/liveportrait/landmark.onnx"
    ...
    xpose_ckpt_path: str = "/inspire/hdd/project/agileapplication/zhangkaipeng-24043/mm1/CloneMyFaceCloneMyVoice/LivePortrait/pretrained_weights/liveportrait_animals/xpose.pth"
